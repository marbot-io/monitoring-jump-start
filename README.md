...
| [VPC interface endpoint](marbot-interface-endpoint.yml) | [Launch Stack](https://console.aws.amazon.com/cloudformation/home#/stacks/create/review?templateURL=https://s3-eu-west-1.amazonaws.com/monitoring-jump-start/marbot-interface-endpoint.yml) | `https://s3-eu-west-1.amazonaws.com/monitoring-jump-start/marbot-interface-endpoint.yml` |
